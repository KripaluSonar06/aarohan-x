...
def main():
    ...
    print(f"Total at-risk Rs: {results['total_at_risk_paise']/100:.2f}")
    print(f"Gross recovered Rs: {results['gross_recovered_paise']/100:.2f}")
    print(f"Contact cost Rs: {results['contact_cost_inr']:.2f}")
    print(f"Net recovered Rs: {results['net_recovered_paise']/100:.2f}")
